...
public class TicketAdapterDone extends ListAdapter<Ticket,TicketAdapterDone.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ticket_list_item_done,parent,false);
        return new TicketAdapterDone.ViewHolder(view, parent.getContext(), position ->{
